...
\definecolor{sqlblue}{RGB}{0,0,128}    % Тёмно-синий
\definecolor{sqlgreen}{RGB}{0,128,0}   % Тёмно-зелёный
\definecolor{sqlred}{RGB}{128,0,0}     % Тёмно-красный
...
\lstset{
	...
	backgroundcolor=\color{white!100},    % Белый фон
	rulecolor=\color{black},              % Чёрная рамка
	breaklines=true,                      % Переносы строк
	showstringspaces=false,               % Не показывать знаки пробелов в строках
